...
const navItems = [
  ...
  { label: "NEMSIS", href: "/nemsis", icon: "database" },
  { label: "NFIRS", href: "/nfirs", icon: "fire" },
  { label: "Fire", href: "/fire", icon: "flame" },
  { label: "Fire RMS", href: "/fire/rms", icon: "file" },
  { label: "HEMS", href: "/hems", icon: "helicopter" },
  { label: "Aviation", href: "/hems/aviation", icon: "plane" },
  { label: "Telehealth", href: "/telehealth", icon: "video" },
  { label: "Comms Hub", href: "/comms", icon: "phone" },
  { label: "CrewLink", href: "/crewlink", icon: "users" },
  { label: "Inventory", href: "/inventory", icon: "box" },
  { label: "HR", href: "/hr", icon: "briefcase" },
  { label: "Support", href: "/ops/support", icon: "headset" },
