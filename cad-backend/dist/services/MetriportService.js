...
class MetriportService {
    constructor(apiKey, facilityId) {
        ...
        try {
            this.client = new api_sdk_1.MetriportMedicalApi(apiKey, {
     ...
     */
    async searchPatient(params, facilityId) {
        if (!this.client) {
        ...
        try {
            ...
            const matchedPatient = patients.patients.find(p => p.firstName.toLowerCase() === params.firstName.toLowerCase() &&
     ...
     */
    async createPatient(params, facilityId) {
        if (!this.client) {
     ...
     */
    async getConsolidatedRecords(patientId) {
        if (!this.client) {
     ...
     */
    async getPatientHistorySummary(patientId) {
        if (!this.client) {
     ...
     */
    async extractTransportRelevantInfo(patientId) {
     ...
     */
    async checkRecentTransports(patientId, daysBack = 30) {
     ...
     */
    mockConsolidatedRecords(patientId) {
...
exports.MetriportService = MetriportService;
//# sourceMappingURL=MetriportService.js.map